					...
					<div class="clr">
						...
						<div class="right">
							<h2>Personal Info</h2>
								...
								<div class="clr"><div class="input-box">Date of birth </div><span>--</span></div>
								<div class="clr"><div class="input-box">Address</div><span>--</span></div>
								<div class="clr"><div class="input-box">Phone</div> <span>--</span>  </div>
